...
texts = np.asarray([[line[index - 5 : index + 5] for index in range(9, sequence_len + 9)] for line in origin_data])
...
model = Sequential()
model.add(Embedding(max_words, embedding_dim))  # Random embedding
